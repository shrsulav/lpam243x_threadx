...
print(f"Getting the SYSFW HS-FS (signed, encrypted) binary for {release_tag} ...")
...
print(f"Getting the inner certificate binary for SYSFW HS-FS binary for {release_tag} ...")
